...
<!-- ОТКЛЮЧЕНО НА ЭТОЙ УСТАНОВКЕ (22.08.2026, решение пилота).
     Проверка требует РП автора платформы: у него седьмой номер — техдолг бота.
     У пилота под тем же номером другой продукт, совпадение случайное, и план
     дня каждое утро получал бы чужой обязательный пункт. Вернуть, заменив на
     свои обязательные продукты, либо снять совсем.
5. **Mandatory check** — проверить наличие в плане: WP-7 (техдолг бота, ≥30 мин) + ≥1 контентный РП.
-->

5. **Mandatory check** — пропущено: обязательные ежедневные продукты на этой установке не заданы.
